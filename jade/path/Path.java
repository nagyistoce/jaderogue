...
public interface Path {
	...
	public class PathFactory {
		/**
		 * Uses heuristic estimates to quickly find the shortest path between
		 * two points.
		 */
		public static final int AStar = 0;
		/**
		 * Uses Bresenham's Line Drawing to draw a straight line. Suitible for
		 * line of sight.
		 */
	 ...
	 * 
	 * @param world
	 *            the world on which to pathfind
	 * @param start
	 *            the start of the path
	 * @param goal
	 *            the end of the path
	 * @return a list with a path from start to the goal, or null if no path
	 *         exist
	 */
