...
public class Dice extends Random implements Serializable {
	 ...
	 * 
	 * @param seed
	 *            the pseudorandom generator seed
	 */
	 ...
	 * rolled their highest value). However, as x increases, the probability
	 * curve becomes more normally distributed.
	 * 
	 * @param x
	 ...
	 * 
	 * @param min
	 *            the minium ascii value that could be returned
	 * @param max
	 *            the maximuc ascii value that could be returned
