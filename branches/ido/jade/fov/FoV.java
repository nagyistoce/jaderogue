...
public interface FoV {
	/**
	 * Used for retrieving varius singleton instances of FoV implementing
	 * classes.
	 */
	public class FoVFactory {
		 ...
		 *            are provided in FoV
		 * @return a singleton instance of an object implementing FoV with
		 *         specified algorithm
		 */
	...
	/**
	 * Calculates field of vision from a given tile on world. The passable
	 * method is used to determine if light can continue through a square. The
	 * field of vision is limited by the range.
	 * 
	 * @param world
	 *            the world on which the field will be calculated
	 * @param x
	 *            the x-coordinate of the origion of the field of vision
	 * @param y
	 *            the y-coordinate of the origion of the field of vision
	 * @param range
	 *            the maximum range for the field of vision
